        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse text-dark" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <a class="nav-link text-dark" href="/tindakan-index">Tindakan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark" href="/index-resep">Resep</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark" href="/logout-umum">Logout</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <div class="container mt-5">
    <div class="card">
      <div class="card-header">
        <h2 class="card-title">Tindakan Dokter Umum</h2>
        <a class="btn btn-primary btn-add" href="/tindakan-add">Tambah Tindakan</a>
      </div>
      <div class="card-body">
        <table class="table table-striped">
          <thead>
            <tr>
              <th>Pasien Dokter Umum</th>
              <th>Keluhan</th>
              <th>Diagnosa</th>
              <th>Obat</th>
              <th>Resep</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$data->status}}</td>
              <td>
                <a class="btn btn-warning" href="/tindakan-edit/{{$data->id}}">Edit</a>
                <a class="btn btn-danger" href="/tindakan-delete/{{$data->id}}" onclick="return confirm('Yakin Hapus')">Hapus</a>
              </td>
            </tr>
            @endforeach
