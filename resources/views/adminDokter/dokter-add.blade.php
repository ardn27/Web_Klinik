                ...
                <div class="container-fluid">
                    ...
                    <form action="/add">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control" name="spesialis" id="spesialis">
                                <option value="Umum">Dokter Umum</option>
                                <option value="Anak">Dokter Spesialis Anak</option>
                                <option value="Kandungan">Dokter Spesialis Kandungan</option>
                            </select>
                        </div>
                        <!-- end form text field -->
                          <!-- form text field -->
                        ...
                        <!-- form text field -->
                        <div class="mb-3">
                            <label for="" class="form-label">Jadwal Dokter</label>
                            <input type="date" class="form-control" id="jadwal_dokter" name="jadwal_dokter"
                                aria-describedby="emailHelp">
                            <div id="emailHelp" class="form-text"></div>
                        </div>
